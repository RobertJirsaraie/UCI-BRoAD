...
cat raw1_Aparc-Destrieux_${hemisphere}_${property}.txt | tr "\t" "," | sed s@"lh.aparc.a2009s.${property}"@"SUBIDxValidateID"@g | sed s@"/dfs1/som/rao_col/maltx/analysis/freesurfer/"@""@g > raw2_Aparc-Destrieux_${hemisphere}_${property}.txt
