...
CSV<-read.csv("/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/n141_TP2_NMF/n141_Nmf24BasesCT_COMBAT_TP2.csv")
...
ggsave(file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/creationFigures/TP2_COMBAT_NMF/ScatterPlot_ctTP2_Network18.pdf",device = "pdf")
...
ggsave(file="/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/creationFigures/TP2_COMBAT_NMF/ScatterPlot_ctTP2_Network9.pdf",device = "pdf")
