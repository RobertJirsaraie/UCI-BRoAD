...
echo 'This Subject did not have their Niftis Uploaded Properly as of this date:' $TODAY 'Check on Xnat and with Derek to troubleshoot the issue!' > /dfs3/som/rao_col/maltx/scripts/bids/logs/${SubjectID}x${ValidateID}_MissingEPRIME.txt

	else

rm /dfs3/som/rao_col/maltx/scripts/bids/logs/${SubjectID}x${ValidateID}_MissingEPRIME.txt
