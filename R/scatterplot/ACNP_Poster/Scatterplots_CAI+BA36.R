...
ResponceVars <- names(DATA)[grep("left_BA36",names(DATA))]
...
ggsave(file="/dfs1/som/rao_col/sandbox/jirsaraie/MALTX/figures/ACNP_Poster/ScatterPlot_CAI_BA32.pdf",device = "pdf",width = 12, height = 9, units = c("in"))
